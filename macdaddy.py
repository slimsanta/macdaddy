...
def get_arguments():
    ...
    if not options.interface:
        ...
        parser.error("[x] Please specify new MAC address. Use --help for more info")
    return options
...
if current_mac == options.new_mac:
    print("[✓] MAC address was successfully changed to " + current_mac + " on interface " + options.interface)
else:
